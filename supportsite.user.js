...
var buttons = {
    ...
    'abuse_message' : ['Abuse of System', "Hi ##appealName##, \n\nYou were banned for filing numerous false reports for other players. As moderators, we check every report users make, and abusing the report system in this manner only prevents us from doing our jobs, not to mention leading others to be unjustly banned. Please refrain from repeatedly issuing false reports in the future, as it will result in a ban.\n\nIf you feel you were unjustly reported, feel free to come onto [IRC] (http://webchat.freenode.net/?channels=tpmods) and discuss your report there.\n\n*Please let us know if you have any further questions or concerns.*\n\n\Regards, "+modName],
